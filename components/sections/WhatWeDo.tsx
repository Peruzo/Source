...
const services: Service[] = [
  ...
  },
  {
    ...
    description:
      'Automatiserad marknadsföring som gör jobbet åt dig. Vår AI analyserar beteenden, optimerar kampanjer och visar vad som faktiskt ger resultat.',
    details: [
  ...
  },
  {
    ...
    description:
      'Full kontroll på ekonomi, produkter och leveranser. Från betalning till fakturering och bokföring – allt kopplat till dina logistikpartners.',
    details: [
              ...
              <div className="relative w-full max-w-[1800px] mx-auto px-6 md:px-10 lg:px-8">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div className="glass relative rounded-[2.5rem] md:rounded-[5rem] aspect-[16/9] flex items-center justify-center border border-white/20 overflow-hidden">
